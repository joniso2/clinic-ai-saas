    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-zinc-800 px-6 py-4">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-zinc-100">פרטי עסק לחשבוניות</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-200 dark:border-zinc-700
                bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-slate-900 dark:text-zinc-100
          ...
          {/* Address */}
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-zinc-300 mb-1.5">כתובת</label>
            <input
              type="text"
              value={form.address ?? ''}
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-100 dark:border-zinc-800 px-6 py-4">
          <button
            onClick={onClose}
            disabled={saving}
            className="rounded-lg border border-slate-200 dark:border-zinc-700 px-4 py-2 text-sm
              text-slate-600 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors
              disabled:opacity-40"
          >
            ביטול
          </button>
