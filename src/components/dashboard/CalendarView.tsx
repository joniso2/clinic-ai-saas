                ...
                >
                  ...
                  <span className={`inline-flex h-6 w-6 items-center justify-center rounded-full text-xs font-semibold transition-colors ${
                    isToday
                      ...
                      : 'text-slate-700 dark:text-zinc-300 group-hover:bg-slate-200 dark:group-hover:bg-zinc-600'
                  }`}>
                    {day}
                  </span>
                  ...
                  {dayApts.length > 0 && (
                    <span className="absolute top-2 right-2 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-slate-900 dark:bg-zinc-100 px-1 text-[9px] font-bold text-white dark:text-zinc-900">
                      {dayApts.length}
                    </span>
                  )}
