  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 left-0 z-50 h-full md:hidden flex flex-col bg-white shadow-2xl
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
          ...
          <button
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition-colors active:scale-95"
