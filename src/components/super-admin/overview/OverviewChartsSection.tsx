...
function IntegrationRow({ record }: { record: IntegrationStatusRecord }) {
  ...
  return (
    <div className="flex items-center gap-3 py-2.5 border-b border-zinc-800 last:border-0">
      ...
      <div className="flex-1 bg-zinc-800 rounded-full overflow-hidden h-1.5">
        <div
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        <span className="text-xs font-medium text-zinc-300">{record.label}</span>
            ...
            return (
              <div className="mt-3 flex justify-end gap-4 text-right">
                <span className="text-[11px] text-zinc-500">
                  לידים: <span className="text-zinc-300 font-medium">{totLeads.toLocaleString('he-IL')}</span>
                </span>
                <span className="text-[11px] text-zinc-500">
                  תורים: <span className="text-zinc-300 font-medium">{totAppts.toLocaleString('he-IL')}</span>
                </span>
                <span className="text-[11px] text-zinc-500">
