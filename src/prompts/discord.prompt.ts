...
export function buildDiscordSystemPrompt(): string {
  ...
  return (
    ...
    'SPECIAL CASE: If the patient says they want the earliest/closest available slot, or "whatever is available soonest", or similar —\n' +
    'You MUST still collect name and phone first if not already provided.\n' +
    'Only AFTER you have name + phone: set appointment_datetime to the next business day at 09:00 Israel time (YYYY-MM-DDT09:00:00) and book.\n' +
    'Do NOT ask for confirmation of the time. Just book it and tell the patient what you booked.\n' +
