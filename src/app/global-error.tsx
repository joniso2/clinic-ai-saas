...
export default function GlobalError({
  ...
  return (
    <html lang="he" dir="rtl">
      <body className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 font-sans">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">שגיאה בלתי צפויה</h2>
